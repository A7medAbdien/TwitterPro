...
keys = {'tweets': 0, 'replies': 0, 'likes': 0, 'fLikes': 0,
        'following': 0}
USER = "Elon musk"
...
tf_uni_titles = {'tweets': tf_uni_tweets, 'replies': tf_uni_replies, 'likes': tf_uni_liked,
                 'fLikes': tf_uni_fliked}
...
tf_bi_titles = {'tweets': tf_bi_tweets, 'replies': tf_bi_replies, 'likes': tf_bi_liked,
                'fLikes': tf_bi_fliked}
...
user_titles = {'replies': user_replies, 'likes': user_liked, 'fLikes': user_fliked}
...
topic_titles = {'tweets': topic_tweets, 'replies': topic_replies, 'likes': topic_liked,
                'fLikes': topic_fliked}
